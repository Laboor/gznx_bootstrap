<template>
	<div class="log-view">
		<div class="tool-bar">
			<el-tooltip v-if="printSuspend" content="继续" :hide-after="2000" :open-delay="500">
		...
		<log-message ref="logMessage" url="ws://localhost:8080/webSocketServer" :suspend="printSuspend" :theme="theme" @connected="handleConnected" />
	</div>
</template>
...
export default {
	...
	methods: {
		...
		handlePlay() {
			this.printSuspend = !this.printSuspend;
		},
		handleSetting() {
